...
//Keep track of mouse position (to move the katana_purple)
...
let objToRender = 'katana_purple';

//Instantiate a loader for the .gltf file
const loader = new GLTFLoader();

//Load the katana_purple model
loader.load(
  `./models/${objToRender}/scene.gltf`,
  function (gltf) {
    object = gltf.scene;
        // object.scale.set(200, 20, 100);
    //     object.scale.set(150, 20, 350);
...
function animate() {
  ...
  // Make the katana_purple follow the mouse
  if (object) {
