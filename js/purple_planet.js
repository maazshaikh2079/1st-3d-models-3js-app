...
//Keep track of mouse position (to move the purple_planet)
...
let objToRender = 'purple_planet';

//Instantiate a loader for the .gltf file
const loader = new GLTFLoader();

//Load the purple_planet model
loader.load(
...
function animate() {
  ...
  // Make the purple_planet follow the mouse
  if (object) {
